        ...
        <div class="form-container sign-up" id="signUpSession" style="{{ $errors->any() ? 'display: block;' : 'display: none;' }}">
            <form method="POST" action="{{ route('register') }}" id="registerForm">
                ...
                <div class="social-icons">
                    <a href="{{ route('login.google') }}" class="icon"><i class="fa-brands fa-google-plus-g"></i></a>
                    <a href="{{ route('login.github') }}" class="icon"><i class="fa-brands fa-github"></i></a>
                </div>
