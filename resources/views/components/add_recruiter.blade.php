    ...
    <form action="/create_recruiter" method="post">
        ...
        <div class="bg-white shadow rounded-lg px-6 py-6 mb-5 h-[330px]">
            ...
            <div class="mb-4">
                ...
                <input type="text" name='recruiter_name' id="recruiter_name" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="Job Recruiter name">
            </div>
            <div class="mb-4">
                <label for="email" class="block text-sm font-medium text-gray-700">Email</label>
                <input type="email" name='email' id="email"  class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="Recruiter's email">
            </div>
        </div>
        <div class="bg-white shadow rounded-lg p-6 mb-5 h-[260px]">
            ...
            <div class="mb-4">
                ...
                <input type="text" name='company_name' id="company_name" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm sm:text-sm" placeholder="Name of the company">
            </div>
        </div>
        <div class="h-48"></div>
